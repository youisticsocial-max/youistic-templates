    ...
    <div className="shop-page section container" style={{ paddingTop: '120px' }}>
      ...
      <div className="shop-header">
        <div className="shop-title-area">
          <h1>Explore Jewels</h1>
          <p className="subtitle">Discover our curated collection of premium Indian jewelry.</p>
        </div>
      </div>
        ...
        <aside className={`shop-sidebar ${isFilterOpen ? 'open' : ''}`}>
          ...
          <div className="filter-group">
            ...
            <div className="price-filter">
              <input type="range" min="0" max="5000" defaultValue="5000" className="price-slider" />
          ...
          <div className="filter-group">
            <h3 className="filter-title">Variation <ChevronDown size={18} /></h3>
            <div className="size-grid">
              {['Standard', 'One Size', '2.2', '2.4', '2.6', '2.8'].map(size => (
